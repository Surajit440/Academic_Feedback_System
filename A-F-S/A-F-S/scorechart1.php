...
<head>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        $select = "SELECT avg(Q1),avg(Q2),avg(Q3),avg(Q4),avg(Q5) FROM `feedback` WHERE `TEACHER_NAME`= '$TNAME' AND `SUBJECT` = '$SUBJECT' AND `YEAR`= '$ye'";
        ...
        $ye2 = --$ye1;  
        $select2 = "SELECT avg(Q1),avg(Q2),avg(Q3),avg(Q4),avg(Q5) FROM `feedback` WHERE `TEACHER_NAME`= '$TNAME' AND `SUBJECT` = '$SUBJECT' AND `YEAR`= '$ye2'";
